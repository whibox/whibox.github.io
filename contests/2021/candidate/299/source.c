...
int init(){
    ...
    mpz_init_set_str(d, "3A0F803A874CD5B826023F2073FF200371D399E76E66B05E1241AA787B0564D6" ,16);//set d
    kpoint(Q_x, Q_y, d, G_x, G_y);
}

void aux_ECDSA_256_sign(unsigned char sig[64], const unsigned char hash[32]) 
{
